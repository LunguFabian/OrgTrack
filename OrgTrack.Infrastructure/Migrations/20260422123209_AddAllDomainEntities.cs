        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_ActivityLogs_OrganizationUnits_OrganizationUnitId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Events_OrganizationUnits_OrganizationUnitId",
                        column: x => x.OrganizationUnitId,
                        principalTable: "OrganizationUnits",
                        principalColumn: "Id",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Tasks_OrganizationUnits_OrganizationUnitId",
                        column: x => x.OrganizationUnitId,
                        principalTable: "OrganizationUnits",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_InviteLinks_OrganizationUnits_OrganizationUnitId",
                        column: x => x.OrganizationUnitId,
                        principalTable: "OrganizationUnits",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_InviteLinks_Roles_RoleId",
                        column: x => x.RoleId,
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_UserUnitRoles", x => x.Id);
                    table.ForeignKey(
                        name: "FK_UserUnitRoles_OrganizationUnits_OrganizationUnitId",
                        column: x => x.OrganizationUnitId,
                        principalTable: "OrganizationUnits",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_UserUnitRoles_Roles_RoleId",
                        column: x => x.RoleId,
                        principalTable: "Roles",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ActivityLogs_OrganizationUnitId",
                table: "ActivityLogs",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Events_OrganizationUnitId",
                table: "Events",
                column: "OrganizationUnitId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_InviteLinks_OrganizationUnitId",
                table: "InviteLinks",
                column: "OrganizationUnitId");

            migrationBuilder.CreateIndex(
                name: "IX_InviteLinks_RoleId",
                table: "InviteLinks",
                column: "RoleId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Tasks_OrganizationUnitId",
                table: "Tasks",
                column: "OrganizationUnitId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_UserUnitRoles_OrganizationUnitId",
                table: "UserUnitRoles",
                column: "OrganizationUnitId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_UserUnitRoles_UserId_OrganizationUnitId_RoleId",
                table: "UserUnitRoles",
                columns: new[] { "UserId", "OrganizationUnitId", "RoleId" },
                unique: true);
        }
