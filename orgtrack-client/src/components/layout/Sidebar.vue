...
<template>
  <div 
    class="flex flex-col w-64 bg-dark-surface border-r border-dark-border min-h-screen fixed left-0 top-0 z-50 transition-transform duration-300 ease-in-out lg:translate-x-0"
  ...
  >
    ...
    <div class="h-16 flex items-center justify-between px-6 border-b border-dark-border">
      <div class="flex items-center gap-2">
        ...
        <span class="text-xl font-bold text-white tracking-tight">OrgTrack</span>
      </div>
